...
| `usecase4` | UC4: char[] Two-Pointer | `UC4_CharArrayTwoPointer.java` |
| `usecase5` | UC5: Stack (LIFO) | `UC5_StackBased.java` |
| `usecase6` | UC6: Queue + Stack | `UC6_QueueStackComparison.java` |
| `usecase7` | UC7: Deque (Bidirectional) | `UC7_DequeOptimized.java` |
| `usecase8` | UC8: Linked List | `UC8_LinkedListBased.java` |
| `usecase9` | UC9: Recursion | `UC9_RecursivePalindrome.java` |
| `usecase10` | UC10: Normalization | `UC10_Normalization.java` |
| `usecase11` | UC11: OOP Encapsulation | `UC11_OopEncapsulation.java` |
